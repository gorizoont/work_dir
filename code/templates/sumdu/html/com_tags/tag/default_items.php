...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<?php else : ?>
		<div class="blog category list-striped">
			<?php foreach ($items as $i => $item) : ?>
				<?php if ($item->core_state == 0) : ?>
					<div class="system-unpublished cat-list-row<?php echo $i % 2; ?>">
				<?php else : ?>
					<div class="items-row cat-list-row<?php echo $i % 2; ?> clearfix">
						<div class="item">
						...
						<?php else : ?>
							...
							<?php
							$image_intro = json_decode($item->core_images);
							if (!empty($image_intro->image_intro)) :
							?>
							<div class="pull-left item-image">
								<a href="<?php echo $item->link; ?>">
									<img src="<?php echo htmlspecialchars($image_intro->image_intro); ?>" alt="" itemprop="thumbnailUrl">
								</a>
							</div>
							<?php endif; ?>
