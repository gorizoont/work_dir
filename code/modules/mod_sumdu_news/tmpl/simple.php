...
<section class="news news--simple">
	...
	<?php else : ?>
		<div class="news__list news__list--simple <?php echo $news_list_class; ?>" <?php echo $columns_count ? 'data-news-columns="'.$columns_count.'"' : ''; ?>>
			<?php foreach ($list as $item) : ?>
				<?php require JModuleHelper::getLayoutPath('mod_sumdu_news', '_item-simple'); ?>
